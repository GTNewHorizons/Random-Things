...
public class ImbuingRecipe
{
	...
	public boolean matchesInventory(IInventory e)
	{
		...
		if (!InventoryUtils.areItemStackContentEqual(center, toImbue) && !ItemUtils.areOreDictionaried(center, toImbue))
		{
			return false;
		}
	...
	private boolean containsItemStack(HashMap<ItemStack, Boolean> list, ItemStack is)
	{
		...
		{
			if (InventoryUtils.areItemStackContentEqual(testItemStack, is) || ItemUtils.areOreDictionaried(testItemStack, is))
			{
