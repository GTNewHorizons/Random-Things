...
public class BloodmoonSpawner {
    ...
    protected static ChunkPosition func_151350_a(World p_151350_0_, int p_151350_1_, int p_151350_2_) {
        ...
        int i1 = p_151350_0_.rand.nextInt(
                chunk == null ? p_151350_0_.getActualHeight() : chunk.getTopFilledSegment() + 16 - 1);
            ...
            for (int k3 = 0; k3 < k; ++k3) {
                ...
                if ((!enumcreaturetype.getPeacefulCreature() || p_77192_3_)
                        ...
                        && p_77192_1_.countEntities(enumcreaturetype, true)
                                <= enumcreaturetype.getMaxNumberOfCreature()
                                            ...
                                            label103:
                                            {
                                                ...
                                                if (p_77192_1_.canBlockSeeTheSky(k2, l2, i3)
                                                        && canCreatureTypeSpawnAtLocation(
                                                                enumcreaturetype, p_77192_1_, k2, l2, i3)) {
                                                    float f = k2 + 0.5F;
                                                    float f1 = l2;
                                                    float f2 = i3 + 0.5F;

                                                    if (p_77192_1_.getClosestPlayer(
                                                                    f, f1, f2, Settings.BLOODMOON_SPAWNRANGE)
                                                            == null) {
                                                        ...
                                                        if (f6 >= 576.0F) {
                                                            ...
                                                            Result canSpawn = ForgeEventFactory.canEntitySpawn(
                                                                    entityliving, p_77192_1_, f, f1, f2);
                                                            if (canSpawn == Result.ALLOW
                                                                    || (canSpawn == Result.DEFAULT
                                                                ...
                                                                if (!ForgeEventFactory.doSpecialSpawn(
                                                                        entityliving, p_77192_1_, f, f1, f2)) {
                                                                    ientitylivingdata = entityliving.onSpawnWithEgg(
                                                                            ientitylivingdata);
                                                                }
    ...
    public static boolean canCreatureTypeSpawnAtLocation(
            EnumCreatureType p_77190_0_, World p_77190_1_, int p_77190_2_, int p_77190_3_, int p_77190_4_) {
        if (p_77190_0_.getCreatureMaterial() == Material.water) {
            return p_77190_1_
                            .getBlock(p_77190_2_, p_77190_3_, p_77190_4_)
                            .getMaterial()
                            .isLiquid()
                    && p_77190_1_
                            .getBlock(p_77190_2_, p_77190_3_ - 1, p_77190_4_)
                            .getMaterial()
                            .isLiquid()
                    && !p_77190_1_
                            .getBlock(p_77190_2_, p_77190_3_ + 1, p_77190_4_)
