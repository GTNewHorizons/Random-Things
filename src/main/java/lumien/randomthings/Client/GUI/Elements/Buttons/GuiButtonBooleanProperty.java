...
public class GuiButtonBooleanProperty extends GuiButton
{
	...
	public GuiButtonBooleanProperty(GuiContainer gc, String propertyName, int itemID, int itemDamage, int slot, int buttonID, int posX, int posY, ResourceLocation image, String toolTipTrue, String toolTipFalse)
	{
	...
	public void func_146113_a(SoundHandler p_146113_1_)
	{
		...
		this.value = !value;
		PacketHandler.INSTANCE.sendToServer(new MessageChangeItemProperty(itemID, itemDamage, slot, propertyName, this.value));
	}
