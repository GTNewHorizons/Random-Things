...
public class GuiItemFilter extends GuiContainer {
    ...
    public void initGui() {
        ...
        metadataButton = new GuiButtonBooleanProperty(
                this,
                "metadata",
                Item.getIdFromItem(ModItems.filter),
                1,
                player.inventory.currentItem,
                0,
                guiLeft + 195,
                guiTop + 4,
                new ResourceLocation("randomthings:textures/gui/buttonMetadata.png"),
                ClientUtil.translate("text.miscellaneous.useMetadata"),
                ClientUtil.translate("text.miscellaneous.ignoreMetadata"));
        metadataButton.setValue(itemFilter.stackTagCompound.getBoolean("metadata"));
        this.buttonList.add(metadataButton);

        oreDictButton = new GuiButtonBooleanProperty(
                this,
                "oreDict",
                Item.getIdFromItem(ModItems.filter),
                1,
                ...
                guiLeft + 173,
                guiTop + 4,
                new ResourceLocation("randomthings:textures/gui/buttonOreDict.png"),
                ClientUtil.translate("text.miscellaneous.useOreDict"),
                ClientUtil.translate("text.miscellaneous.ignoreOreDict"));
