        ...
        if (!worldObj.isRemote) {
            ...
            if (this.age >= 200) {
                ...
                EntityPlayerMP player = MinecraftServer.getServer().getConfigurationManager()
                        .func_152612_a(toRevive.playerName);
                if (player != null) {
                    if (player.getHealth() <= 0) {
                        EntityPlayerMP revived = player.playerNetServerHandler.playerEntity = MinecraftServer
                                .getServer().getConfigurationManager().respawnPlayer(player, 0, false);
                        ...
                        revived.playerNetServerHandler
                                .setPlayerLocation(posX, posY, posZ, revived.rotationYaw, revived.rotationPitch);
