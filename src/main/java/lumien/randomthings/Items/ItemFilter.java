...
public class ItemFilter extends ItemBase implements IItemWithProperties {
                ...
                switch (par1ItemStack.getItemDamage()) {
                    ...
                    case 2:
                        ...
                        if (!(entityID == 0)) {
                            ...
                            par3List.add(
                                    I18n.format("text.miscellaneous.entityName", (Object[]) null) + ": " + entityName);
                        }
                        break;
                    case 3:
    ...
    public static DimensionCoordinate getPosition(ItemStack positionFilter) {
        ...
        return new DimensionCoordinate(
                positionFilter.stackTagCompound.getInteger("dimension"),
                positionFilter.stackTagCompound.getInteger("filterX"),
                positionFilter.stackTagCompound.getInteger("filterY"),
                positionFilter.stackTagCompound.getInteger("filterZ"));
    }
