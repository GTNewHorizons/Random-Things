...
public class RTConfiguration {
    ...
    public static void onConfigChange(OnConfigChangedEvent event) {
        if (event.modID.equals(Reference.MOD_ID)) syncConfig();
    }
